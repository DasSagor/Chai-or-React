    ...
    >
      <div className=" fixed flex flex-wrap justify-center bg-slate-200 bottom-12 inset-x-0 px-4 mx-4 rounded-xl">
        <div className="flex flex-wrap h-10 gap-0.5 sm:gap-4 xl:gap-6 py-1">
          ...
          <button
            className="bg-green-700 px-4 rounded-2xl text-white"
            onClick={() => setColor("green")}
          >
            Green
          </button>
          <button
            className="bg-blue-700 px-4 rounded-2xl text-white"
          ...
          <button
            className="bg-white px-4 rounded-2xl font-semibold"
          ...
          <button
            className="bg-black px-4 rounded-2xl text-white"
